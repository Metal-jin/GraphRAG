...
- 生成时间：`2026-09-08T15:30:29+08:00`
- 评测问题数：`50`
- 统一 `top_k`：`5`
...
|---|---:|---:|---:|---:|---:|---:|
| art_lineage | 50/50 | 100.00% | 0 | 0.00% | 0.00% | 31.15 |
| library_graphrag | 50/50 | 100.00% | 3 | 6.00% | 6.00% | 1357.78 |
| master_chain | 50/50 | 100.00% | 1 | 2.00% | 2.00% | 273.58 |
| sect_agg | 50/50 | 100.00% | 0 | 0.00% | 0.00% | 29.12 |
| vector | 50/50 | 100.00% | 2 | 4.00% | 4.00% | 1880.61 |
...
| q003 | vector | ok | 否 | 根据现有资料无法回答。 |
| q004 | vector | ok | 否 | 根据现有资料无法回答。 |
| q005 | vector | ok | 是 | 柯镇恶 |
| q006 | vector | ok | 否 | 根据现有资料无法回答。 |
...
| q003 | library_graphrag | ok | 否 | 根据现有资料无法回答。 |
| q004 | library_graphrag | ok | 否 | 根据现有资料无法回答。 |
| q005 | library_graphrag | ok | 是 | 柯镇恶 |
| q006 | library_graphrag | ok | 否 | 根据现有资料无法回答。 |
| q007 | library_graphrag | ok | 否 | 根据现有资料无法回答。 |
| q008 | library_graphrag | ok | 否 | 根据现有资料无法回答。 |
| q009 | library_graphrag | ok | 否 | 欧阳锋的侄子是谁？根据现有资料无法回答。 |
| q010 | library_graphrag | ok | 否 | 根据现有资料无法回答。 |
| q011 | library_graphrag | ok | 否 | 根据现有资料无法回答。 |
| q012 | library_graphrag | ok | 否 | 根据现有资料无法回答。 |
...
| q024 | library_graphrag | ok | 否 | 根据现有资料无法回答。 |
| q025 | library_graphrag | ok | 否 | 根据现有资料无法回答。 |
...
| q039 | library_graphrag | ok | 否 | 根据现有资料无法回答。 |
| q040 | library_graphrag | ok | 否 | 根据现有资料无法回答。 |
| q041 | library_graphrag | ok | 是 | 郭靖的妻子是黄蓉，黄蓉的父亲是黄药师。 |
...
| q003 | master_chain | ok | 否 | 根据现有资料无法回答。 |
| q004 | master_chain | ok | 否 | 根据现有资料无法回答。 |
| q005 | master_chain | ok | 是 | 柯镇恶 |
| q006 | master_chain | ok | 否 | 根据现有资料无法回答。 |
...
| q050 | master_chain | ok | 否 | 根据现有资料无法回答。 |
